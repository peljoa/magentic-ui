...
from .models import User, Token, TokenData, UserRole, UserStatus
...
class MSALService:
    ...
    async def exchange_code_for_token(self, code: str, state: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if "error" in result:
                logger.error(f"MSAL token exchange error: {result.get('error_description')}")
                raise HTTPException(
    ...
    def store_session_data(self, session_id: str, data: Dict[str, Any], expire_seconds: int = 3600):
